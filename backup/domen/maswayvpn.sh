...
echo -e  "\033[0;33m    MOD DARI SAYA BY MasWayVPN           \033[0;33m"
echo -e  "\033[0;33m          ADA PERTANYAAN CHAT               \033[0;33m"
echo -e  "\033[0;33m    WA :     083120857907                   \033[0;33m"
echo -e  "\033[1;31m============================================\033[0m"
read -rp " TEKAN ENTER UNTUK MELANJUTKAN "
sub=$(</dev/urandom tr -dc a-z0-9 | head -c4)
SUB_DOMAIN=${sub}.masway-vpn.my.id
CF_ID=akunaba.abal7770@gmail.com
