...
echo -e "==================================================" | lolcat
echo -e   "[${GREEN} 01 ${NC}]. •Create Account WIREGUARD"
echo -e   "[${GREEN} 02 ${NC}]. •Delete Account WIREGUARD"
echo -e   "[${GREEN} 03 ${NC}]. •Renew Account WIREGUARD"
echo -e   "[${GREEN} 04 ${NC}]. •BACK MENU"
echo -e   "[${RED} 05 ${NC}]. •EXIT"
echo -e "==================================================" | lolcat
