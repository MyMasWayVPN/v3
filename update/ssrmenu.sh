...
echo -e "==================================================" | lolcat
echo -e   "[${GREEN} 01 ${NC}]. •Create Account SHADOWSOCKS-R"
echo -e   "[${GREEN} 02 ${NC}]. •Delete Account SHADOWSOCKS-R"
echo -e   "[${GREEN} 03 ${NC}]. •Renew Account SHADOWSOCKS-R"
echo -e   "[${GREEN} 04 ${NC}]. •Cek User Login"
echo -e   "[${GREEN} 05 ${NC}]. •BACK MENU"
echo -e   "[${RED} 06 ${NC}]. •EXIT"
echo -e "==================================================" | lolcat
