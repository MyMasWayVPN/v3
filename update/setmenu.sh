...
echo -e   "===========================================================" | lolcat
echo -e   "[${GREEN} 01 ${NC}]. Add Or Change Subdomain Host For VPS"
echo -e   "[${GREEN} 02 ${NC}]. Change Port Of Some Service"
echo -e   "[${GREEN} 03 ${NC}]. Autobackup Data VPS"
echo -e   "[${GREEN} 04 ${NC}]. Backup Data VPS"
echo -e   "[${GREEN} 05 ${NC}]. Restore Data VPS"
echo -e   "[${GREEN} 06 ${NC}]. Webmin Menu"
echo -e   "[${GREEN} 07 ${NC}]. Limit Bandwith Speed Server"
echo -e   "[${GREEN} 08 ${NC}]. Check Usage of VPS Ram"
echo -e   "[${GREEN} 09 ${NC}]. Reboot VPS"
echo -e   "[${GREEN} 10 ${NC}]. Speedtest VPS"
echo -e   "[${GREEN} 11 ${NC}]. Displaying System Information"
echo -e   "[${GREEN} 12 ${NC}]. Info Script Auto Install"
echo -e   "[${GREEN} 13 ${NC}]. Menu"
echo -e   "[${GREEN} 14 ${NC}]. Restart All Service"
echo -e   "[${GREEN} 15 ${NC}]. Cek All Service"
echo -e   "[${GREEN} 16 ${NC}]. Exit"
echo -e   "===========================================================" | lolcat
echo -e   "\E[44;1;39m            ⇱ Sc By MasWayVPN ⇲              \E[0m"
echo -e   "===========================================================" | lolcat
echo -e   ""
