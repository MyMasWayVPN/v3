...
clear
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/MyMasWayVPN/v3/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://raw.githubusercontent.com/MyMasWayVPN/v3/main/websocket/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/MyMasWayVPN/v3/main/websocket/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://raw.githubusercontent.com/MyMasWayVPN/v3/main/websocket/ws-tls
